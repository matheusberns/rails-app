...
class UsuariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create usuario" do
    assert_difference('Usuario.count') do
      post usuarios_url, params: { usuario: { password: @usuario.password, user: @usuario.user } }
    end
  ...
  test "should update usuario" do
    patch usuario_url(@usuario), params: { usuario: { password: @usuario.password, user: @usuario.user } }
